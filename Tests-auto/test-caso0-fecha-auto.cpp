...
#define fecha_is_eq(f, d, m, a) (f.año() == a && f.mes() == m && f.dia() == d)

#define chk_eq_fecha(f, d, m, a)\
  fct_xchk(\
    fecha_is_eq(f,d,m,a),\
    "failed chk_eq_fecha:\n<%02d/%02d/%04d>!=<%02d/%02d/%04d>",\
    f.dia(), f.mes(), f.año(), d, m, a)
#define Fecha_chk_eq chk_eq_fecha

namespace {
  int añoSistema, mesSistema, diaSistema;
  bool bPrimera = true;
}
...
FCTMF_FIXTURE_SUITE_BGN(test_fecha) {
  ...
  FCT_TEARDOWN_END();
   ...
   FCT_TEST_BGN(Fecha - Ctor.: dia-mes-año; no ceros) {
    ...
    FCT_TEST_BGN(Fecha - Ctor.: dia-mes; no ceros) {
      const Fecha f(17, 7);
      Fecha_chk_eq(f, 17, 7, añoSistema);
    }
    FCT_TEST_END();

    FCT_TEST_BGN(Fecha - Ctor.: dia; no cero) {
      const Fecha f(1);
      Fecha_chk_eq(f, 1, mesSistema, añoSistema);
    }
    FCT_TEST_END();
    ...
    FCT_TEST_BGN(Fecha - Ctor.: dia-cero) {
      const Fecha f(2, 0);
      Fecha_chk_eq(f, 2, mesSistema, añoSistema);
    }
    FCT_TEST_END();

    FCT_TEST_BGN(Fecha - Ctor.: dia-mes-cero) {
      const Fecha f(3, 7, 0);
      Fecha_chk_eq(f, 3, 7, añoSistema);
    }
    FCT_TEST_END();
    ...
    FCT_TEST_BGN(Fecha - Ctor.: cero-mes-cero) {
      ...
      Fecha_chk_eq(f, diaSistema, 3, añoSistema);
    }
    FCT_TEST_END();
    
    FCT_TEST_BGN(Fecha - Ctor.: predeterminado) {
      const Fecha hoy;
      Fecha_chk_eq(hoy, diaSistema, mesSistema, añoSistema);
    }
    FCT_TEST_END();

    FCT_TEST_BGN(Fecha - Ctor.: cero-cero-cero) {
      const Fecha f(0, 0, 0);
      Fecha_chk_eq(f, diaSistema, mesSistema, añoSistema);
    }
    FCT_TEST_END();
    ...
    FCT_TEST_BGN(Fecha - Ctor.: copia) {
      ...
      const Fecha g(f);
      Fecha_chk_eq(f, g.dia(), g.mes(), g.año());
    ...
    FCT_TEST_BGN(Fecha - Ctor.: cadena 0/mes/0) {
      ...
      Fecha_chk_eq(f, diaSistema, 10, añoSistema);
    }
    FCT_TEST_END();
    ...
    FCT_TEST_BGN(Fecha - Ctor.: dia no valido ni para bisiesto) {
      fct_chk_ex(Fecha::Invalida, Fecha(30, 2, 2004));
    }
    FCT_TEST_END();
    ...
    FCT_TEST_BGN(Fecha - Ctor.: año no valido) {
    ...
    FCT_TEST_BGN(Fecha - Ctor. cadena: año no valido) {
      fct_chk_ex(Fecha::Invalida, Fecha("1/1/-1"));
    }
    FCT_TEST_END();

    FCT_TEST_BGN(Fecha - Constantes AñoMinimo y AñoMaximo) {
      fct_chk_eq_int(Fecha::AñoMinimo, 1902);
      fct_chk_eq_int(Fecha::AñoMaximo, 2037);
    }
    FCT_TEST_END();
    ...
    FCT_TEST_BGN(Fecha - Preincremento - fecha fuera de rango) {
      fct_chk_ex(Fecha::Invalida, Fecha f(31, 12, Fecha::AñoMaximo); ++f);
    }
    FCT_TEST_END();
    ...
    FCT_TEST_BGN(Fecha - Predecremento - fecha fuera de rango) {
      fct_chk_ex(Fecha::Invalida, Fecha f(1, 1, Fecha::AñoMinimo); --f);
    }
    FCT_TEST_END();
    ...
    FCT_TEST_BGN(Fecha - Suma de dias - fecha + dias) {
      const Fecha f(31, 5, 2020);
      const Fecha g(f.operator +(31));
      Fecha_chk_eq(g, 1, 7, 2020);
    }
    FCT_TEST_END();

    FCT_TEST_BGN(Fecha - Suma de dias - fecha fuera de rango) {
      fct_chk_ex(Fecha::Invalida, const Fecha f(31, 12, Fecha::AñoMaximo);
		 f + 7);
    }
    FCT_TEST_END();
    ...
    FCT_TEST_BGN(Fecha - Resta de dias - fecha - dias) {
      ...
      Fecha_chk_eq(g, 27, 2, 2024);
    }
    FCT_TEST_END();

    FCT_TEST_BGN(Fecha - Resta de dias - fecha fuera de rango) {
      fct_chk_ex(Fecha::Invalida, Fecha f(1, 1, Fecha::AñoMinimo); f - 3);
    }
    FCT_TEST_END();
    ...
    FCT_TEST_BGN(Fecha - Suma con asignacion: fecha fuera de rango) {
      fct_chk_ex(Fecha::Invalida, Fecha f(31, 12, Fecha::AñoMaximo); f += 2);
    }
    FCT_TEST_END();
    ...
    FCT_TEST_BGN(Fecha - Resta con asignacion: fecha fuera de rango) {
      fct_chk_ex(Fecha::Invalida, Fecha f(1, 1, Fecha::AñoMinimo); f -= 2);
    }
    FCT_TEST_END();
    ...
    FCT_TEST_BGN(Fecha - Observadores dia-mes-año){
      const Fecha f(29, 2, 2000);
      fct_chk_eq_int(f.dia(), 29);
      fct_chk_eq_int(2, f.mes());
      fct_chk_eq_int(f.año(), 2000);
    }
    FCT_TEST_END();
